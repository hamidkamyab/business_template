...
const Navbar = () => {
    ...
    return (
        <section className='navbar container d-flex flex-column-reverse flex-md-row align-items-center justify-content-between pt-0 pt-md-4 gap-3 gap-md-0'>
            <nav className={`mobile ${showMenu?'show':''} col-12 col-md-6 d-flex flex-md-row flex-column align-items-center gap-3 px-2 py-3 py-md-0`}>
            ...
            <div className="left col-12 col-md-6 px-2 d-flex justify-content-center justify-content-md-end position-relative py-2 pt-md-0">
